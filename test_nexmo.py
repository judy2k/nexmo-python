...
class NexmoClientTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.user_agent = 'nexmo-python/{0}/{1}'.format(nexmo.__version__,
    ...
    def stub(self, method, url):
        responses.add(method, url, body='{"key":"value"}', status=200,
    ...
    def test_get_country_pricing(self):
        self.stub(responses.GET,
                  'https://rest.nexmo.com/account/get-pricing/outbound')
    ...
    def test_get_voice_pricing(self):
        ...
        self.assertIsInstance(self.client.get_voice_pricing('447525856424'),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('phone=447525856424', request_query())
    ...
    def test_update_settings(self):
        ...
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('moCallBackUrl=http%3A%2F%2Fexample.com%2Fcallback',
                      request_body())
    ...
    def test_get_available_numbers(self):
        ...
        self.assertIsInstance(self.client.get_available_numbers('CA', size=25),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_get_message_rejections(self):
        ...
        self.assertIsInstance(
            self.client.get_message_rejections(date='YYYY-MM-DD'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_search_messages(self):
        ...
        self.assertIsInstance(
            self.client.search_messages(to='1234567890', date='YYYY-MM-DD'),
            dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('date=YYYY-MM-DD', request_query())
    ...
    def test_search_messages_by_ids(self):
        ...
        self.assertIsInstance(self.client.search_messages(
            ids=['00A0B0C0', '00A0B0C1', '00A0B0C2']), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_send_ussd_prompt_message(self):
        ...
        params = {'from': 'long-virtual-number', 'to': '447525856424',
                  'text': 'Hello'}

        self.assertIsInstance(self.client.send_ussd_prompt_message(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_send_event_alert_message(self):
        ...
        params = {'to': '16365553226', 'server': 'host',
                  'link': 'http://example.com/'}

        self.assertIsInstance(self.client.send_event_alert_message(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('to=16365553226', request_body())
    ...
    def test_send_marketing_message(self):
        ...
        params = {'from': 'short-code', 'to': '16365553226', 'keyword': 'NEXMO',
                  'text': 'Hello'}
    ...
    def test_resubscribe_event_alert_number(self):
        self.stub(responses.POST,
                  'https://rest.nexmo.com/sc/us/alert/opt-in/manage/json')

        params = {'msisdn': '441632960960'}

        self.assertIsInstance(
            self.client.resubscribe_event_alert_number(params), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_initiate_tts_prompt_call(self):
        ...
        params = {'to': '16365553226', 'text': 'Hello', 'max_digits': 4,
                  'bye_text': 'Goodbye'}

        self.assertIsInstance(self.client.initiate_tts_prompt_call(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('to=16365553226', request_body())
        self.assertIn('text=Hello', request_body())
    ...
    def test_send_verification_request(self):
        ...
        self.assertIsInstance(self.client.send_verification_request(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('number=447525856424', request_body())
        self.assertIn('brand=MyApp', request_body())
    ...
    def test_check_verification(self):
        ...
        self.assertIsInstance(
            self.client.check_verification('8g88g88eg8g8gg9g90', code='123445'),
            dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_check_verification_request(self):
        ...
        self.assertIsInstance(self.client.check_verification_request(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('code=123445', request_body())
        self.assertIn('request_id=8g88g88eg8g8gg9g90', request_body())
    ...
    def test_cancel_verification(self):
        ...
        self.assertIsInstance(
            self.client.cancel_verification('8g88g88eg8g8gg9g90'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_trigger_next_verification_event(self):
        ...
        self.assertIsInstance(
            self.client.trigger_next_verification_event('8g88g88eg8g8gg9g90'),
            dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_control_verification_request(self):
        ...
        self.assertIsInstance(self.client.control_verification_request(params),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('cmd=cancel', request_body())
        self.assertIn('request_id=8g88g88eg8g8gg9g90', request_body())
    ...
    def test_get_basic_number_insight(self):
        ...
        self.assertIsInstance(
            self.client.get_basic_number_insight(number='447525856424'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
    ...
    def test_get_number_insight(self):
        ...
        self.assertIsInstance(
            self.client.get_number_insight(number='447525856424'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('number=447525856424', request_query())
    ...
    def test_update_application(self):
        self.stub(responses.PUT,
                  'https://api.nexmo.com/v1/applications/xx-xx-xx-xx')

        params = {'answer_url': 'https://example.com/ncco'}

        self.assertIsInstance(
            self.client.update_application('xx-xx-xx-xx', params), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertIn('answer_url=https%3A%2F%2Fexample.com%2Fncco',
                      request_body())
    ...
    def test_update_call(self):
        ...
        self.assertIsInstance(
            self.client.update_call('xx-xx-xx-xx', action='hangup'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertEqual(request_content_type(), 'application/json')
    ...
    def test_send_audio(self):
        self.stub(responses.PUT,
                  'https://api.nexmo.com/v1/calls/xx-xx-xx-xx/stream')

        self.assertIsInstance(self.client.send_audio('xx-xx-xx-xx',
                                                     stream_url='http://example.com/audio.mp3'),
                              dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertEqual(request_content_type(), 'application/json')
        self.assertEqual(request_body(),
                         b'{"stream_url": "http://example.com/audio.mp3"}')

    @responses.activate
    def test_stop_audio(self):
        self.stub(responses.DELETE,
                  'https://api.nexmo.com/v1/calls/xx-xx-xx-xx/stream')
    ...
    def test_send_speech(self):
        self.stub(responses.PUT,
                  'https://api.nexmo.com/v1/calls/xx-xx-xx-xx/talk')

        self.assertIsInstance(
            self.client.send_speech('xx-xx-xx-xx', text='Hello'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertEqual(request_content_type(), 'application/json')
    ...
    def test_send_dtmf(self):
        self.stub(responses.PUT,
                  'https://api.nexmo.com/v1/calls/xx-xx-xx-xx/dtmf')

        self.assertIsInstance(
            self.client.send_dtmf('xx-xx-xx-xx', digits='1234'), dict)
        self.assertEqual(request_user_agent(), self.user_agent)
        self.assertEqual(request_content_type(), 'application/json')
    ...
    def test_authentication_error(self):
        responses.add(responses.POST, 'https://rest.nexmo.com/sms/json',
                      status=401)
    ...
    def test_client_error(self):
        ...
        self.assertRaisesRegex(nexmo.ClientError, message,
    ...
    def test_server_error(self):
        ...
        self.assertRaisesRegex(nexmo.ServerError, message,
                               self.client.send_message, {})
    ...
    def test_application_info_options(self):
        ...
        self.user_agent = '/'.join(
            ['nexmo-python', nexmo.__version__, platform.python_version(),
    ...
    def test_signature(self):
        ...
        self.assertEqual(self.client.signature(params),
                         '6af838ef94998832dbfc29020b564830')
