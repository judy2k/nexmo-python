...
class Client():
    def __init__(self, **kwargs):
        ...
        self.api_secret = kwargs.get('secret', None) or os.environ[
            'NEXMO_API_SECRET']
    ...
    def control_verification_request(self, params=None, **kwargs):
        warnings.warn('nexmo.Client#control_verification_request is deprecated',
                      DeprecationWarning, stacklevel=2)
    ...
    def post(self, host, request_uri, params):
        ...
        return self.parse(host,
                          requests.post(uri, data=params, headers=self.headers))
    ...
    def put(self, host, request_uri, params):
        ...
        return self.parse(host,
                          requests.put(uri, data=params, headers=self.headers))
    ...
    def __get(self, request_uri, params={}):
        ...
        return self.parse(self.api_host, requests.get(uri, params=params,
